...
<body>
  ...
  if (isset($_POST['submit'])) {
    ...
    $id_pelanggan = $_POST['No_Id'];
    $tgl_masuk = $_POST['tgl_masuk'];
    $tgl_keluar = $_POST['tgl_keluar'];
    $lama_menginap = $_POST['lama_menginap'];
    $Tarif = $_POST['Tarif'];

    $q = mysqli_query($con, "INSERT INTO transaksi(No_Faktur,No_Kamar,No_Id,tgl_masuk,tgl_keluar,lama_menginap,Tarif) VALUES('$No_Faktur','$No_Kamar','$id_pelanggan','$tgl_masuk','$tgl_keluar','$lama_menginap','$Tarif')");
